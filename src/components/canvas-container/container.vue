...
function handleWheel(event: WheelEvent) {
	...
	const newOffsetX = state.offsetX - (x - state.offsetX) * (scaleChange / contextState.value.scale);
	const newOffsetY = state.offsetY - (y - state.offsetY) * (scaleChange / contextState.value.scale);
