...
<template>
  <div class="flex h-full flex-col">
    <div class="relative flex items-center px-4 py-2 h-[52px]">
      <Label class="leading-9 font-bold">{{ layoutStore.contextState.carpetName }}</Label>
    ...
    <div class="flex flex-1">
      <Container>
        <Render ref="canvasRef">
          <component :is="layoutStore.activeCarpet.renderCanvas(layoutStore.contextState)" />
        </Render>
      </Container>
